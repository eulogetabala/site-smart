...
<li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php"><i class='fas fa-home'></i> Tableau de bord</a>
 </li>

<!--==== accordion list-3 =====-->
<li class="nav-item accordion-content hide">
<h3 class="title"><i class='fas fa-cog'></i> paramètre</h3>
<ul class="description navbar-nav">

     <li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php?cat=website-setting&subcat=website-menu"> Menu</a>
    </li>
      <li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php?cat=website-setting&subcat=website-setting">Website-Setting</a>
    </li>
      <li class="nav-item">
      <a class="nav-link content-link" href="dashboard.php?cat=website-setting&subcat=theme-setting">Theme </a>
    </li>
...
<!--==== accordion list-3 =====-->
<li class="nav-item accordion-content hide">
<h3 class="title"><i class='fas fa-envelope'></i> Contactez-nous</h3>
<ul class="description navbar-nav">
